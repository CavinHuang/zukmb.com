...
<div class="layui-header header header-doc">
    <div class="layui-main">
       ...
       {{-- <div class="nav-user">
            ...
            <span>
                <a href="javascript:void(0);" data-url="/login.html" class="dologin">登入</a>
                <a class="dologin" href="javascript:;" data-url="/register.html">注册</a>
            </span>
            <p class="out-login">
                <a href="http://www.itkee.cn/api/callback/qq_connect.html" onclick="layer.msg('正在通过QQ登入', {icon:16, shade: 0.1, time:0})" class="iconfont icon-qq" title="QQ登入"></a>
            </p>
        </div>--}}
    </div>
</div>
